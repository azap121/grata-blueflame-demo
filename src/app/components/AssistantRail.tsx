import { faBookOpenLines, faClipboardCheck, faMagnifyingGlass, faPlus } from '@fortawesome/pro-light-svg-icons';
...
export type AssistantRailMode = 'chat' | 'skills' | 'templates';
